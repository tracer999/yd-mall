...
const adminDescriptions = {
    ...
    b2b: '사업자 회원 승인, 기업 전용가, 접수→승인→입금확인→출고, 취소·반품과 계좌 환불, 견적·협상',
    sales: '주문 목록·상세 조회와 주문 상태 변경 (일반 회원 주문 전용)',
    shipping: '송장 입력·배송 완료 처리, 기본 배송비·무료배송 기준·도서산간 할증 (일반 회원 주문 전용)',
    claims: '취소·반품 승인/거절과 환불 처리 (일반 회원 주문 전용)',
    users: '회원 목록·상세 조회, 비활성화',
    inquiries: '고객 1:1 문의 답변과 자주 묻는 질문(FAQ) 관리',
    reviews: '고객 리뷰 확인과 숨기기·삭제, 리뷰 적립 정책',
...
const userDescriptions = {
    ...
    b2b: '사업자 회원 가입·승인 대기, 기업 전용가 표시, 결제 없이 접수되는 기업 주문, 견적 요청',
...
const mallBuilderDescriptions = {
    ...
    theme_design: '색상·로고(사이트 설정), 모서리·글꼴(디자인 스타일), 헤더 레이아웃, 메인 히어로 이미지를 몰에 맞게 다듬는 방법',
