...
| 배송중 · 배송완료 | **반품** 또는 **교환** (고객이 선택) | 클레임 관리에서 **승인 대기** (수령 후 7일 이내) |

- 반품은 **수령 후 7일 이내**만 신청할 수 있습니다.
- 사유는 **단순변심 / 상품불량 / 오배송 / 기타** 중에서 고릅니다.
- 승인 전(처리 중) 상태면 고객이 스스로 **철회**할 수 있습니다.
- **교환도 신청할 수 있습니다.** 배송중·배송완료 구간에서 반품 대신 교환을 고르면, 물건을 회수한 뒤 같은 상품을 다시 보내 드립니다(환불 없음).
- **일부 상품만 신청할 수 있습니다.** 3개 중 1개만 반품하는 것이 가능하며, 신청 창에서 상품별 수량을 고릅니다. 이때 **배송비는 남은 상품이 있는 동안 환불되지 않습니다.**
