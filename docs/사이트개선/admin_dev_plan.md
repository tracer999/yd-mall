...
- **회원 등급 · 멤버십 혜택 — 2차** — 1차 MVP + 2차 대부분(쿠폰팩 3종=진입·생일·정기, 혜택별 사용여부 토글, 대시보드 비용 분석) 완료·이관됨(위 표 · [`membership_grade_admin_design.md`](./membership_grade_admin_design.md) 부록 B.5). 남은 2차: 상품/브랜드별 등급 혜택·고객 세그먼트·강등 사전 알림(이메일)·설정형 할인 우선순위.
