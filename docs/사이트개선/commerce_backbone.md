...
| 4 | **발급 조건 확장** (등급·누적구매·생일) | 등급·누적구매 축은 **멤버십 설계로 이관** → [`membership_grade_admin_design.md`](./membership_grade_admin_design.md) §7.1(쿠폰 혜택)·부록 A.4. 이 모듈에는 **생일 등 쿠폰 자체 발급조건**만 남는다. 선행: 멤버십 등급 테이블 도입 |
