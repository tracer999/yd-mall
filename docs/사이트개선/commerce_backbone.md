...
| 4 | **발급 조건 확장** (등급·누적구매·생일) | 등급·누적구매 축은 **멤버십으로 이관·구현 완료**(등급 쿠폰팩 3종 = 진입·생일·정기 → [`develop_guide/admin/membership.md`](../develop_guide/admin/membership.md)). 이 모듈에는 **쿠폰 자체 발급조건**만 남는다 |
