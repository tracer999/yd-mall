...
> 작성 2026-07-10. 입력 레퍼런스: `쿠폰관리.md` (일반론·업계 표준) — 이 문서에 흡수·접지되어 **삭제됨**.
> 원문: `git show b97e257:"docs/사이트개선/쿠폰관리.md"`.
...
입력 일반론(`쿠폰관리.md`, 삭제됨)이 제시한 항목과 현행을 대조한다.
...
| **비용 부담 주체 · 쿠폰 복사 · API/주문조건 발급 · 성과 분석 탭** | 삭제된 일반론(`쿠폰관리.md`)에 있었으나 **단일 판매자**라 부담 주체가 무의미하고, 나머지는 운영 편의 기능이다 | 입점형 전환(부담 주체) 또는 운영 요구 발생 시. 원문: `git show b97e257:"docs/사이트개선/쿠폰관리.md"` |
